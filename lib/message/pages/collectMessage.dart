...
class CollectMessage extends StatefulWidget {
  ...
  @override
  State<CollectMessage> createState() => _CollectMessage();
}

class _CollectMessage extends State<CollectMessage> {
  @override
  void initState() {
    Future.delayed(Duration(milliseconds: 5), () async {
      widget.onChange(1, widget.newMessage.length);
    });
    super.initState();
  }
