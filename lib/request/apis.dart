...
class APIS {
  /// 验证码登录接口
  static loginByCode(String phone, String code) async {
    var data =
  ...
  /// 密码登录接口
  static loginByPassword(String phone, String password) async {
  ...
  /// 用户注册
  static register(String phone, String code, String password) async {
    var data =
  ...
  /// 推荐作品
  static workRecommend({int? page_num, int? page_size, String? type}) async {
    var data = await HttpUtil()
  ...
  /// 搜索接口
  static search(String scope, String key,
  ...
  /// 获取关注用户最新作品
  static getFocusWork({int? user_id}) async {
    var data = await HttpUtil().get('/focus/work?user_id=$user_id');
    return data;
  }

  /// 关注用户
  static focusPeople(int user_id) async {
    var data = await HttpUtil().post('/focus', data: {user_id});
    return data;
  }

  /// 获取关注列表
  static getFocus({int? page_num, int? page_size}) async {
    var data = await HttpUtil().get('/getFocus');
    return data;
  }

  /// 发表评论
  static publishComment(String content, int work_id, int to_comment_id) async {
    var data = await HttpUtil()
  ...
  /// 获取评论
  static getComment(int rank_type, int work_id) async {
    var data = await HttpUtil()
  ...
  /// 点赞
  static like(int scope, String id) async {
    var data = await HttpUtil().post('/like?scope=$scope', data: {id});
    return data;
  }

  /// 收藏作品
  static collection(int work_id) async {
  ...
  /// 获取其他用户收藏作品
  static getOtherCollection(int user_id,
  ...
  /// 获取其他用户点赞作品
  static getOtherLike(int user_id, {int? page_size, int? page_num}) async {
    var data = await HttpUtil().post(
